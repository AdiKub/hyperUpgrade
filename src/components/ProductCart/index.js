			...
			<div className='container'>
				<div className='product-cart-wrapper'>
					...
					<div className='product-cart-table'>
						...
						{cart && cart.map((pc)=> 
									<div key={pc._id} className='product-cart-table-items product-cart-table-line'>
									<div className='product-cart-table__card product-cart-table__product'>
										...
										<h4 className='product-cart-table__card__name'> {pc.pcname} </h4>
									</div>
									<div className='product-cart-table-header__name product-cart-table__available'>
										<span > {pc.inStock ? 'in stock' : 'not'}  </span>
									</div>
